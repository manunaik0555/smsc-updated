...
CREATE TABLE `delivery_address` (
  ...
  PRIMARY KEY (`Id`),
  KEY `delivery_address_ibfk_1` (`CustomerId`),
  CONSTRAINT `delivery_address_ibfk_1` FOREIGN KEY (`CustomerId`) REFERENCES `customers` (`Id`)
...
-- Dump completed on 2023-10-30 22:47:47
